...
export class InitialMigration1731981975581 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await this.executeQuery(
      queryRunner,
      `CREATE TABLE "employee_services" ("service_id" uuid NOT NULL, "employee_id" uuid NOT NULL, CONSTRAINT "PK_673fd236e781ddb746dd590616a" PRIMARY KEY ("service_id", "employee_id"))`,
    );
    await this.executeQuery(
      queryRunner,
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await this.executeQuery(queryRunner, `DROP TABLE "employee_services"`);
    await this.executeQuery(queryRunner, `DROP TABLE "bookings"`);
    await this.executeQuery(queryRunner, `DROP TYPE "public"."bookings_status_enum"`);
    await this.executeQuery(queryRunner, `DROP TABLE "services"`);
    await this.executeQuery(queryRunner, `DROP TABLE "employees"`);
    await this.executeQuery(queryRunner, `DROP TABLE "users"`);
